...
public class Banking {
    ...
    public void alterarArquivo(String cpfAlvo, int operation, Double saldo){
        ...
        try (RandomAccessFile arquivo = new RandomAccessFile(nomeArquivo, "rw")) {
            ...
            while ((linha = arquivo.readLine()) != null) {
                System.out.println("ENTERING CPF SCANNING");
                ...
                if (temp[1].equals(cpfAlvo) || temp[1].equals(destRemet[0])) {
                    System.out.println("INSIDE IF DECLARATION");
                    String novo;
                    String opt;
                    ...
                    if (acesso==true && operation==1) {
                        ...
                        switch (opt) {
                            ...
                            alterarArquivo(concac, 2, Double.parseDouble(temp[4]));
                                break;
                            default:
                                break;
                        }
